/*! Retype v4.0.1 | retype.com | Copyright 2026. Retype, Inc. All rights reserved. */
          ...
          ((j.version = "2.3.9"),
            ...
            (j.Pipeline.prototype.add = function () {
              Array.prototype.slice.call(arguments).forEach(function (e) {
                (j.Pipeline.warnIfFunctionNotRegistered(e),
                  this._stack.push(e));
              }, this);
            }),
            ...
            (j.Index.prototype.query = function (e) {
              ...
              for (a = 0; a < t.clauses.length; a++) {
                ...
                for (var h = 0; h < l.length; h++) {
                  var d = l[h];
                  u.term = d;
                  var f = j.TokenSet.fromClause(u),
                    p = this.tokenSet.intersect(f).toArray();
                  if (
                    0 === p.length &&
                    u.presence === j.Query.presence.REQUIRED
                  ) {
                    for (var y = 0; y < u.fields.length; y++) {
                      s[(R = u.fields[y])] = j.Set.empty;
                    }
                    break;
                  }
                  for (var m = 0; m < p.length; m++) {
                    ...
                    for (y = 0; y < u.fields.length; y++) {
                      ...
                      if (
                        ...
                        u.presence != j.Query.presence.PROHIBITED)
                      ) {
                        if (
                ...
                if (u.presence === j.Query.presence.REQUIRED)
                  for (y = 0; y < u.fields.length; y++) {
              ...
              if (null != t) {
                ...
                switch (i.type) {
                  ...
                  default:
                    ...
                    throw new j.QueryParseError(r, i.start, i.end);
                }
              }
            }),
